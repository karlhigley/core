...
from merlin.dag.async_executors import AsyncLocalExecutor
from merlin.dag.base_operator import BaseOperator
from merlin.schema.schema import ColumnSchema, Schema


@pytest.mark.asyncio
async def test_async_local_executor_with_dataframe():
    ...
    result = await executor.transform(df, [graph.output_node])
